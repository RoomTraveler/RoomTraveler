            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="importForm">
                        ...
                        <div class="mb-3">
                            <label for="limit" class="form-label">가져올 숙소 수</label>
                            <input type="number" class="form-control" id="limit" name="limit" min="1" max="50" value="10">
                            <div class="form-text">1~50 사이의 숫자를 입력하세요. 숫자가 클수록 시간이 오래 걸립니다.</div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#startImport").click(function() {
                ...
                if (confirm("선택한 조건으로 숙소 데이터를 가져오시겠습니까? 이 작업은 시간이 오래 걸릴 수 있습니다.")) {
                    $.ajax({
